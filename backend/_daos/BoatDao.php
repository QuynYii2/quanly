 ...
 if (!defined("BOAT_DAO_INC")) {
	...
	class BoatDao extends DbConnect /*DbMySQLConnect*/  {
		...
		function getDataFull($id){
		 	$query = ' SELECT a.*, fl.name, fl.alias, fl.introtext FROM tbl_boat AS a ';
			$query.= ' LEFT JOIN tbl_boat_lang AS fl ON a.id = fl.boat';
        ...
        function getServices($id = null){
            ...
            $query.= ' AND d.language = ? AND a.genre = "boat" ORDER BY b.name ';
