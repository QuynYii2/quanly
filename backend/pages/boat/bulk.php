<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_BOAT') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
    ...
    /**
    $search     = false;
    foreach ($FormSearch as $key => $val):
        if (strlen($val)) $search = true;
    endforeach;
    ...
    **/
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=boat&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
