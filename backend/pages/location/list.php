<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_LOCATION') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("location.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=location&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
