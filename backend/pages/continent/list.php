<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_CONTINENT') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("continent.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=continent&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
