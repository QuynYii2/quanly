<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_PERSON') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("person.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=person&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
