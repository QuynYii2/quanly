<?php
    ...
    **/
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_OPERATION') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
    ...
    endforeach;
    $smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=operation&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
