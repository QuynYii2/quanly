<?php
	...
	if ($cid[0]) $smarty->assign("TitlePage", Generals::getTitle('MENU_EXPENSES') ." <span>[".Generals::getTitle('MENU_SUB_EDIT')."]</span>");
	else $smarty->assign("TitlePage", Generals::getTitle('MENU_EXPENSES') ." <span>[".Generals::getTitle('MENU_SUB_ADD')."]</span>");
    ...
    $payments   = $ObjectDao->getPayments(1);
    $changelogs = $ObjectDao->getChangeLogs($cid[0], 1);
    $paytypes   = $ObjectDao->getPaymentTypes();
