<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_RPTGUIDE') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=rptguide&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
