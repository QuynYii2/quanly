<?php
	...
	if ($cid[0]) $smarty->assign("TitlePage", Generals::getTitle('MENU_SPOKEN') ." <span>[".Generals::getTitle('MENU_SUB_EDIT')."]</span>");
	else $smarty->assign("TitlePage", Generals::getTitle('MENU_SPOKEN') ." <span>[".Generals::getTitle('MENU_SUB_ADD')."]</span>");
