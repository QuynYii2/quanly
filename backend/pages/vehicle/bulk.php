<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_VEHICLE') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("vehicle.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=vehicle&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
