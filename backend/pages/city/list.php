<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_CITY') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("city.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=city&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
