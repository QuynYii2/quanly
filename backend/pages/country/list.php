<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_COUNTRY') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=country&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
