<?php
    ...
    $toolbar.= Generals::getToolBar('edit', 		Generals::getTitle('TOOLBAR_EDIT'), 		'edit');
    $toolbar.= Generals::getToolBar('copy', 		Generals::getTitle('TOOLBAR_COPY'), 		'copy');
