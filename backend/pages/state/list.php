<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_STATE') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	$Cities	 	= $ObjectDao->getCities($FormSearch['country']);
	$page		= Generals::getState('page', 1) ? Generals::getState('page', 1) : 1;
	
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=state&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
