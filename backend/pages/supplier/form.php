<?php
	...
	if ($cid[0]) $smarty->assign("TitlePage", Generals::getTitle('MENU_SUPPLIER') ." <span>[".Generals::getTitle('MENU_SUB_EDIT')."]</span>");
	else $smarty->assign("TitlePage", Generals::getTitle('MENU_SUPPLIER') ." <span>[".Generals::getTitle('MENU_SUB_ADD')."]</span>");
    ...
    if (!is_array($ObjectData['services'])) $ObjectData['services'] = explode(',', $ObjectData['services']);
