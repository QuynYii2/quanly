<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_ENTRANCE') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("entrance.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=entrance&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
