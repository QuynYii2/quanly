<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_EXPTRANS') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=exptrans&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
