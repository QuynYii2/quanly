<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_MISCELL') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("miscell.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=miscell&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
