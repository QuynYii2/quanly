<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_FLIGHT') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("flight.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=flight&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
