<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_TOUR') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	#==================================================================
	#==================================================================
	$ObjectDao 	= new QuotationDao('extquotation', true);
    ...
    endforeach;
    $smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=tour&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
