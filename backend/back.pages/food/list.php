<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_FOOD') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("food.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=food&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
