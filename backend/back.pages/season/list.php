<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_SEASON') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("season.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=season&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
