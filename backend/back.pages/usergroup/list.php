<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_USERGROUP') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=usergroup&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
