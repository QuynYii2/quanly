<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_CURRENCIES') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
	$smarty->config_load("currencies.conf");
	#==================================================================
	#==================================================================
	...
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=currencies&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
