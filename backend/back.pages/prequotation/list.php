<?php
	...
	$smarty->assign("TitlePage", Generals::getTitle('MENU_PREQUOTATION') ." <span>[".Generals::getTitle('MENU_SUB_LIST')."]</span>");
    ...
    endforeach;
	$smarty->assign("paging",   	PagerUtils::PagerSmarty($page, $DataCount, "index.php?option=prequotation&view=list", (int)LIMIT_RECORD, (int)PAGES_SIZES));
